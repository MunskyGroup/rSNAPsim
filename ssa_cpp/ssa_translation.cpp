...
static PyObject *__pyx_pw_15ssa_translation_1run_SSA(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_result,&__pyx_n_s_ribtimes,&__pyx_n_s_kelong,&__pyx_n_s_t_array,&__pyx_n_s_kbind,&__pyx_n_s_kcompl,&__pyx_n_s_FRAP,&__pyx_n_s_Inhibitor,&__pyx_n_s_inhibit_time,&__pyx_n_s_seed,&__pyx_n_s_nribs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ribtimes)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 1); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kelong)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 2); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_t_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 3); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kbind)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 4); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kcompl)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 5); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_FRAP)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 6); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Inhibitor)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 7); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_inhibit_time)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 8); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  9:
        if (likely((values[9] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seed)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 9); __PYX_ERR(0, 16, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case 10:
        if (likely((values[10] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nribs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, 10); __PYX_ERR(0, 16, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_nribs = ((PyArrayObject *)values[10]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 11, 11, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_15ssa_translation_run_SSA(__pyx_self, __pyx_v_result, __pyx_v_ribtimes, __pyx_v_kelong, __pyx_v_t_array, __pyx_v_kbind, __pyx_v_kcompl, __pyx_v_FRAP, __pyx_v_Inhibitor, __pyx_v_inhibit_time, __pyx_v_seed, __pyx_v_nribs);
 ...
 * 
 * 
 *     translationSSA (&kelong[0], &t_array[0], Nt, kbind, kcompl, &result[0], N, FRAP, Inhibitor, inhibit_time,seed,&ribtimes[0],&nribs[0])             # <<<<<<<<<<<<<<
 * 
 *     return None
 */
  __pyx_t_2 = 0;
 ...
 *     I need to write this.
 */
  __pyx_tuple__10 = PyTuple_Pack(13, __pyx_n_s_result, __pyx_n_s_ribtimes, __pyx_n_s_kelong, __pyx_n_s_t_array, __pyx_n_s_kbind, __pyx_n_s_kcompl, __pyx_n_s_FRAP, __pyx_n_s_Inhibitor, __pyx_n_s_inhibit_time, __pyx_n_s_seed, __pyx_n_s_nribs, __pyx_n_s_Nt, __pyx_n_s_N); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 16, __pyx_L1_error)
