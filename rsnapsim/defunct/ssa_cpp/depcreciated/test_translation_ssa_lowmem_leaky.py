...
all_results = np.zeros((Ncolor,n_trajectories,len(t_array)),dtype=np.int32)
...
pl = np.zeros((2, len(kelong)+1), dtype=np.int32)
...
I1 = all_results[0]
I2 = all_results[1]
plt.plot(I1.T,'r'); plt.plot(I2.T,'b');
# # Plotting
# all_traj = np.loadtxt('ivec_1000t')
# #all_traj = ssa_obj_01.intensity_vec
# f,ax = plt.subplots(2,1)
# ax[0].plot(I1[0:50,-500:].T)
# ax[0].plot(I2[0:50,-500:].T)
