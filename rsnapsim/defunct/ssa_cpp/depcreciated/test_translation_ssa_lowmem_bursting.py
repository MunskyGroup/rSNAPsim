...
import numpy as np
import ssa_translation_lowmem_bursting
...
seeds = np.random.randint(0,0x7fffffff,n_trajectories)
...
for i in range(n_trajectories):
    ...
    ssa_translation_lowmem_bursting.run_SSA(result,ribtimes,coltimes,colpointsx,colpointst, kelong,frapresult,t_array,.03,kcompl, 1,0,300, seeds[i],nribs,x0,9, pl,2,.3,1 )
