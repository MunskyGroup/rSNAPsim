...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "ssa_translation_c_w_lowmem_bursting.h"
        ],
        "language": "c++",
        "name": "ssa_translation_lowmem_bursting",
        "sources": [
            "ssa_translation_lowmem_bursting.pyx"
        ]
    },
    "module_name": "ssa_translation_lowmem_bursting"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ssa_translation_lowmem_bursting
#define __PYX_HAVE_API__ssa_translation_lowmem_bursting
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "ssa_translation_c_w_lowmem_bursting.h"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'ssa_translation_lowmem_bursting' */
static __Pyx_TypeInfo __Pyx_TypeInfo_int = { "int", NULL, sizeof(int), { 0 }, 0, IS_UNSIGNED(int) ? 'U' : 'I', IS_UNSIGNED(int), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "ssa_translation_lowmem_bursting"
extern int __pyx_module_is_main_ssa_translation_lowmem_bursting;
int __pyx_module_is_main_ssa_translation_lowmem_bursting = 0;

/* Implementation of 'ssa_translation_lowmem_bursting' */
...
static const char __pyx_k_ssa_translation_lowmem_bursting[] = "ssa_translation_lowmem_bursting.pyx";
static const char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static const char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static const char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static const char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static const char __pyx_k_numpy_core_umath_failed_to_impor[] = "numpy.core.umath failed to import";
static const char __pyx_k_ssa_translation_lowmem_bursting_2[] = "ssa_translation_lowmem_bursting";
...
/* "ssa_translation_lowmem_bursting.pyx":16
...
/* Python wrapper */
static PyObject *__pyx_pw_31ssa_translation_lowmem_bursting_1run_SSA(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_31ssa_translation_lowmem_bursting_run_SSA[] = "\n    I need to write this. \n    ";
static PyMethodDef __pyx_mdef_31ssa_translation_lowmem_bursting_1run_SSA = {"run_SSA", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_31ssa_translation_lowmem_bursting_1run_SSA, METH_VARARGS|METH_KEYWORDS, __pyx_doc_31ssa_translation_lowmem_bursting_run_SSA};
static PyObject *__pyx_pw_31ssa_translation_lowmem_bursting_1run_SSA(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("run_SSA (wrapper)", 0);
  {
    ...
    __pyx_v_Ncolor = __Pyx_PyInt_As_int(values[18]); if (unlikely((__pyx_v_Ncolor == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_kon = __pyx_PyFloat_AsDouble(values[19]); if (unlikely((__pyx_v_kon == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_koff = __pyx_PyFloat_AsDouble(values[20]); if (unlikely((__pyx_v_koff == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("run_SSA", 1, 21, 21, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 16, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("ssa_translation_lowmem_bursting.run_SSA", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_31ssa_translation_lowmem_bursting_run_SSA(__pyx_self, __pyx_v_intensity, __pyx_v_ribtimes, __pyx_v_coltimes, __pyx_v_col_x, __pyx_v_col_t, __pyx_v_kelong, __pyx_v_frap_result, __pyx_v_t_array, __pyx_v_kbind, __pyx_v_kcompl, __pyx_v_FRAP, __pyx_v_Inhibitor, __pyx_v_inhibit_time, __pyx_v_seed, __pyx_v_nribs, __pyx_v_x0, __pyx_v_r_footprint, __pyx_v_probevec, __pyx_v_Ncolor, __pyx_v_kon, __pyx_v_koff);
...
static PyObject *__pyx_pf_31ssa_translation_lowmem_bursting_run_SSA(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_intensity, PyArrayObject *__pyx_v_ribtimes, PyArrayObject *__pyx_v_coltimes, PyArrayObject *__pyx_v_col_x, PyArrayObject *__pyx_v_col_t, PyArrayObject *__pyx_v_kelong, PyArrayObject *__pyx_v_frap_result, PyArrayObject *__pyx_v_t_array, double __pyx_v_kbind, double __pyx_v_kcompl, int __pyx_v_FRAP, int __pyx_v_Inhibitor, double __pyx_v_inhibit_time, int __pyx_v_seed, PyArrayObject *__pyx_v_nribs, PyArrayObject *__pyx_v_x0, int __pyx_v_r_footprint, PyArrayObject *__pyx_v_probevec, int __pyx_v_Ncolor, double __pyx_v_kon, double __pyx_v_koff) {
  int __pyx_v_Nt;
  int __pyx_v_N;
  ...
  /* "ssa_translation_lowmem_bursting.pyx":25
 * 
 *     # subtract 2.
 *     N = len(kelong)             # <<<<<<<<<<<<<<
 *     Nt = t_array.shape[0]
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":26
 *     # subtract 2.
 *     N = len(kelong)
 *     Nt = t_array.shape[0]             # <<<<<<<<<<<<<<
 *     ribtimesize = ribtimes.shape[0]
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":27
 *     N = len(kelong)
 *     Nt = t_array.shape[0]
 *     ribtimesize = ribtimes.shape[0]             # <<<<<<<<<<<<<<
 *     coltimesize = coltimes.shape[0]
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":28
 *     Nt = t_array.shape[0]
 *     ribtimesize = ribtimes.shape[0]
 *     coltimesize = coltimes.shape[0]             # <<<<<<<<<<<<<<
 *     fNt = t_array.shape[0]
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":29
 *     ribtimesize = ribtimes.shape[0]
 *     coltimesize = coltimes.shape[0]
 *     fNt = t_array.shape[0]             # <<<<<<<<<<<<<<
 *     cNt = t_array.shape[0]
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":30
 *     coltimesize = coltimes.shape[0]
 *     fNt = t_array.shape[0]
 *     cNt = t_array.shape[0]             # <<<<<<<<<<<<<<
 *     colNp = col_x.shape[0]
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":31
 *     fNt = t_array.shape[0]
 *     cNt = t_array.shape[0]
 *     colNp = col_x.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ssa_translation_lowmem_bursting.pyx":33
 *     colNp = col_x.shape[0]
 * 
 *     translationSSA (&kelong[0], &t_array[0], Nt, kbind, kcompl, kon, koff, &intensity[0,0], N, FRAP, Inhibitor, inhibit_time,seed,&ribtimes[0],&nribs[0], ribtimesize,fNt,&frap_result[0],coltimesize,&coltimes[0], &col_t[0],&col_x[0],colNp, &x0[0], r_footprint, &probevec[0,0],Ncolor)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_13 = 0;
  __pyx_t_14 = 0;
  translationSSA((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_kelong.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_kelong.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_t_array.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_t_array.diminfo[0].strides))), __pyx_v_Nt, __pyx_v_kbind, __pyx_v_kcompl, __pyx_v_kon, __pyx_v_koff, (&(*__Pyx_BufPtrCContig2d(int *, __pyx_pybuffernd_intensity.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_intensity.diminfo[0].strides, __pyx_t_5, __pyx_pybuffernd_intensity.diminfo[1].strides))), __pyx_v_N, __pyx_v_FRAP, __pyx_v_Inhibitor, __pyx_v_inhibit_time, __pyx_v_seed, (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_ribtimes.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_ribtimes.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_nribs.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_nribs.diminfo[0].strides))), __pyx_v_ribtimesize, __pyx_v_fNt, (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_frap_result.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_frap_result.diminfo[0].strides))), __pyx_v_coltimesize, (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_coltimes.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_coltimes.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_col_t.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_col_t.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_col_x.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_col_x.diminfo[0].strides))), __pyx_v_colNp, (&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_x0.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_x0.diminfo[0].strides))), __pyx_v_r_footprint, (&(*__Pyx_BufPtrCContig2d(int *, __pyx_pybuffernd_probevec.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_probevec.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_probevec.diminfo[1].strides))), __pyx_v_Ncolor);

  /* "ssa_translation_lowmem_bursting.pyx":35
 *     translationSSA (&kelong[0], &t_array[0], Nt, kbind, kcompl, kon, koff, &intensity[0,0], N, FRAP, Inhibitor, inhibit_time,seed,&ribtimes[0],&nribs[0], ribtimesize,fNt,&frap_result[0],coltimesize,&coltimes[0], &col_t[0],&col_x[0],colNp, &x0[0], r_footprint, &probevec[0,0],Ncolor)
 * 
 *     return None             # <<<<<<<<<<<<<<
 * 
...
static int __pyx_pymod_exec_ssa_translation_lowmem_bursting(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_ssa_translation_lowmem_bursting},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "ssa_translation_lowmem_bursting",
    0, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_ssa_translation_lowmem_bursting, __pyx_k_ssa_translation_lowmem_bursting, sizeof(__pyx_k_ssa_translation_lowmem_bursting), 0, 0, 1, 0},
  {&__pyx_n_s_ssa_translation_lowmem_bursting_2, __pyx_k_ssa_translation_lowmem_bursting_2, sizeof(__pyx_k_ssa_translation_lowmem_bursting_2), 0, 0, 1, 1},
 ...
 *     I need to write this.
 */
  __pyx_tuple__8 = PyTuple_Pack(28, __pyx_n_s_intensity, __pyx_n_s_ribtimes, __pyx_n_s_coltimes, __pyx_n_s_col_x, __pyx_n_s_col_t, __pyx_n_s_kelong, __pyx_n_s_frap_result, __pyx_n_s_t_array, __pyx_n_s_kbind, __pyx_n_s_kcompl, __pyx_n_s_FRAP, __pyx_n_s_Inhibitor, __pyx_n_s_inhibit_time, __pyx_n_s_seed, __pyx_n_s_nribs, __pyx_n_s_x0, __pyx_n_s_r_footprint, __pyx_n_s_probevec, __pyx_n_s_Ncolor, __pyx_n_s_kon, __pyx_n_s_koff, __pyx_n_s_Nt, __pyx_n_s_N, __pyx_n_s_ribtimesize, __pyx_n_s_coltimesize, __pyx_n_s_fNt, __pyx_n_s_cNt, __pyx_n_s_colNp); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(21, 0, 28, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_ssa_translation_lowmem_bursting, __pyx_n_s_run_SSA, 16, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initssa_translation_lowmem_bursting(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initssa_translation_lowmem_bursting(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_ssa_translation_lowmem_bursting(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_ssa_translation_lowmem_bursting(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_ssa_translation_lowmem_bursting(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'ssa_translation_lowmem_bursting' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_ssa_translation_lowmem_bursting(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("ssa_translation_lowmem_bursting", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ssa_translation_lowmem_bursting) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ssa_translation_lowmem_bursting")) {
      if (unlikely(PyDict_SetItemString(modules, "ssa_translation_lowmem_bursting", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "ssa_translation_lowmem_bursting.pyx":5
 * import cython
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 *     I need to write this.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_31ssa_translation_lowmem_bursting_1run_SSA, NULL, __pyx_n_s_ssa_translation_lowmem_bursting_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_run_SSA, __pyx_t_1) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "ssa_translation_lowmem_bursting.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ssa_translation_lowmem_bursting", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ssa_translation_lowmem_bursting");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
