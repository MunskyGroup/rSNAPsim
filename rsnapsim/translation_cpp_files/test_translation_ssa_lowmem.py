...
for i in range(n_trajectories):
    ...
    ssa_translation_lowmem.run_SSA( result,ribtimes,coltimes,colpointsx,colpointst, kelong,t_array,.03,kcompl, 0,0,200,201, seeds[i],nribs,x0,9, pl, 2, kon, koff,k_probe,pv,flags,N_rib, photobleaching_rate, photobleaching)
...
plt.figure(dpi=300)
plt.plot(np.mean(all_results[0:100,:,0],axis=0),'b')
plt.xlabel('time')
...
for i in range(n_trajectories):
    ...
    ssa_translation_lowmem.run_SSA(result,ribtimes,coltimes,colpointsx,colpointst, kelong,t_array,.03,kcompl,0,1,200,201, seeds[i],nribs,x0,9, pl, 2, kon, koff,k_probe,pv,flags,N_rib, photobleaching_rate, photobleaching)
...
for i in range(n_trajectories):
    ...
    ssa_translation_lowmem.run_SSA(result,ribtimes,coltimes,colpointsx,colpointst, kelong,t_array,.03,kcompl, 0,0,0,0, seeds[i],nribs,x0,9, pl, 2, kon, koff,k_probe,pv,flags,N_rib)
