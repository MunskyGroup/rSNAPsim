...
// Probe location matrix, 0 if no probe on this codon, 1-N for different colors
	...
	while (tc < tf){
        ...
        std::cout << "_______a0_______" << std::endl;
        std::cout << a0 << std::endl;
        std::cout << "_______event_______" << std::endl;
        ...
        std::cout << "_______event_edited_______" << std::endl;
        std::cout << event << std::endl;
        ...
        std::cout << "_______rxn_mat(event,0)_______" << std::endl;
        std::cout << rxn_mat(event,0) << std::endl;
        ...
        std::cout << "_______state_arr_______" << std::endl;
        std::cout << state_arr << std::endl;
        if (rxn_mat(event,0) == 1){ // state reaction
            state_arr = state_arr +  rxn_mat.row(event).block(0, n_colors+7, 1, n_states).transpose();
        }

        std::cout << "_______rxn_mat.row(event)_______" << std::endl;
        std::cout << rxn_mat.row(event) << std::endl;
        std::cout << "_______rxn_mat.row(event).block(0, n_colors+6, 1, n_states)_______" << std::endl;
        std::cout << rxn_mat.row(event).block(0, n_colors+7, 1, n_states) << std::endl;
        std::cout << "_______state_arr_______" << std::endl;
        std::cout << state_arr << std::endl;
