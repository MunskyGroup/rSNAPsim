...
for i in range(n_trajectories):
    ...
    ssa_translation_generic_lowmem.run_SSA_generic(result, kelong,frapresult,t_array, np.array([0,0,0],dtype=np.float64), seeds[i], k_add.flatten()  ,2,0,3,1, probe.T.astype(int), 2,200 )
